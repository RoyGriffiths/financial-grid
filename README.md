...
A test-data-large.json has been included with a set of 200+ randomly generated value rows if required.
...
2. **Colour coded rows and cells:**

   - For rows: Commodities = White, Equities = Blue, Credit = Green.
   - For Price column cells: +ve = Blue, -ve = Red, 0 = Black.
...
Due to the implimentation, there is a lot of potential for the grid to be improved upon, here's just a few:
